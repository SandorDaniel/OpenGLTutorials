...
template<template<typename, glm::precision> class TVec, typename CoordType, glm::precision precision, const int COMPONENT_COUNT>
VBO<TVec, CoordType, precision, COMPONENT_COUNT>::VBO(VBO&& vbo) : m_id(vbo.m_id), m_element_count_of_vertexbuffer(vbo.m_element_count_of_vertexbuffer)
{
	vbo.m_id = 0;
...
template<template<typename, glm::precision> class TVec, typename CoordType, glm::precision precision, const int COMPONENT_COUNT>
VBO<TVec, CoordType, precision, COMPONENT_COUNT>& VBO<TVec, CoordType, precision, COMPONENT_COUNT>::operator=(VBO&& vbo)
{
	if (this == &vbo)
	{
		return *this;
...
template<template<typename, glm::precision> class TVec, typename CoordType, glm::precision precision, const int COMPONENT_COUNT>
void VBO<TVec, CoordType, precision, COMPONENT_COUNT>::Load(const std::vector<TVec<CoordType, precision>>& g_vertex_buffer_data)
{
...
template<template<typename, glm::precision> class TVec, typename CoordType, glm::precision precision, const int COMPONENT_COUNT>
void VBO<TVec, CoordType, precision, COMPONENT_COUNT>::UnLoad()
{
